...
--	mainGroup = changeCategoryScreenOrientation( mainGroup )
end
...
function scene:show( event )	
	...
	if ( phase == "will" ) then
		...
		local CategoryScreen = require "scripts.classes.screen.CategoryScreen"
		local categoryScreen1 = CategoryScreen.new()
		mainGroup = categoryScreen1:drawScreen()
		
		-- Garbage disposal.
		CategoryScreen = nil
		categoryScreen1 = nil		
		
		--mainGroup = drawCategoryScreen()

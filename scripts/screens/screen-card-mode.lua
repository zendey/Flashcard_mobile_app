-----------------------------------------------------------------------------------------
--
-- screen-card-mode.lua
-- Choose card mode: "Text then image", "Image then text", "Text only", "Image only", "Image + Text"
--
-----------------------------------------------------------------------------------------
...
function settingsMenu( sceneGroup )
	...
	local screenTitle = screen.displayScreenTitle( "Choose card mode:" )
	local cardModeArray = { "Text then image", "Image then text", "Text only", "Image only" }
	-- To put back
